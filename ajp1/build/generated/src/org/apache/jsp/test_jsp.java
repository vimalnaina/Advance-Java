    ...
    try {
      ...
      out.write("\n");
        ...
        if (msg.equals("insert") && request.getParameter("add") != null) {
            ...
            int row = stmt.executeUpdate("insert into products(pname, pstock, pprice, pdesc, pimage) values ('" + pname + "','" + pstock + "','" + pprice + "','" + pdesc + "','" + pimage + "')");
            if (row > 0) {
        ...
        int pprice1 = 0;
        String pdesc1 = "";
        String pimage1 = request.getParameter("pimage");
        if (msg.equals("update")) {
            ...
            while (rs.next()) {
                ...
                pstock1 = rs.getInt(3);
                pprice1 = rs.getInt(4);
                pdesc1 = rs.getString(5);
            }

            if (request.getParameter("upd") != null) {
                response.sendRedirect("updateProduct2.jsp?pid=" + key + "&pname=" + pname1 + "&pstock=" + pstock1 + "&pprice=" + pprice1 + " &pdesc=" + pdesc1 + "&pimage=" + pimage1 + "");
            }
        }
      ...
      out.print(pstock1);
      out.write("\" placeholder=\"Enter Product Stock\" />\n");
      out.write("                            </div>\n");
      out.write("                            <div class=\"col-8 col-12-xsmall\">\n");
