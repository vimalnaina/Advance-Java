    ...
    try {
      ...
      out.write("                        ");
        ...
        if (session.getAttribute("cart") != null) {
            ...
            while (it.hasNext()) {
                int element = it.next();
                ResultSet rs = stmt.executeQuery("select * from products where pid='" + element + "'");
                if (rs.next()) {
                    out.println("<tr>");
                    out.println("<td>" + (++i) + "</td>");
      ...
      out.write("                                <form action=\"buyProduct2.jsp\">\n");
      out.write("                                    <input type=\"submit\" name=\"buy\" value=\"Buy All\" >\n");
      out.write("                                </form>\n");
      out.write("                            </td>\n");
      out.write("                            <td colspan=\"4\">\n");
      out.write("                                <form action=\"ecommerce2.jsp\">\n");
      out.write("                                    <input type=\"submit\" name=\"buymore\" value=\"Add More Items\" >\n");
      out.write("                                </form>\n");
      out.write("                            </td>\n");
      out.write("                        </tr>\n");
      out.write("\n");
