...
public final class payment_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t<input type=\"radio\" id=\"nb\" name=\"radio\" value=\"Net-Banking\" checked>\n");
      out.write("\t\t\t\t\t\t\t<label for=\"nb\">Net-Banking</label>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t<div class=\"col-4 col-12-small\">\n");
      out.write("\t\t\t\t\t\t\t<input type=\"radio\" id=\"db\" name=\"radio\" value=\"DebitCard\">\n");
      out.write("\t\t\t\t\t\t\t<label for=\"db\">Debit Card</label>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t<div class=\"col-4 col-12-small\">\n");
      out.write("\t\t\t\t\t\t\t<input type=\"radio\" id=\"cc\" name=\"radio\" value=\"CreditCard\">\n");
      out.write("\t\t\t\t\t\t\t<label for=\"cc\">Credit Card</label>\n");
      out.write("                        </div>\n");
      out.write("                        <div class=\"col-4 col-12-small\">\n");
      out.write("\t\t\t\t\t\t\t<input type=\"radio\" id=\"cod\" name=\"radio\" value=\"cod\">\n");
      out.write("\t\t\t\t\t\t\t<label for=\"cod\">COD</label>\n");
      out.write("                        </div>\n");
      out.write("                        <div class=\"col-6\">\n");
      out.write("                            <ul class=\"actions\">\n");
      out.write("                                <li><input type=\"submit\" value=\"PAY\" class=\"primary\" /></li>\n");
      out.write("                            </ul>\n");
      out.write("                        </div>\n");
      out.write("                    </form>\n");
      out.write("                </div>\n");
